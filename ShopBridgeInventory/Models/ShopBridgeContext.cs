...
//                optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=ShopBridge;Integrated Security=True");
//            }
//        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<InventoryProducts>(entity =>
            {
                entity.HasKey(e => e.ProductId)
                    .HasName("PK__Inventor__B40CC6CD07878F4C");
            ...
            modelBuilder.Entity<UserInfo>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__UserInfo__1788CC4CC5DB69F0");
